...
km_lsvm_ref <- biopl$ref_kaplan_meier(ref, type = 'aa_ml', cl = 'CRIS-B')

# Compute the Kaplan Meier
km_lsvm <- biopl$compute_kaplan_meier(km_lsvm_ref, group = 'ref',cl = 'CRIS-B')

# Show the plot
biopl$show_km_plot(km_lsvm, alg_name = 'lsvm (ml adapted)')
```
...
count_ml <- ann$get_count_annot_ml(lsvm_custom_testing, annot, mldata$test_ref, type = 'aa_ml')
...
count_ml_pdx <- ann_pdx$get_count_annot_ml(lsvm_custom_testing_pdx, annot_pdx, mldata_pdx$test_ref, type = 'aa_ml')
